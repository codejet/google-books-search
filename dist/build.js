...
/***/ function(module, exports, __webpack_require__) {
	...
	var GoogleBooksSearch = __webpack_require__(163);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	    ...
	    var ReactDOM = window.ReactDOM || __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var qwest = __webpack_require__(164);

	var SearchField = __webpack_require__(165);
	var Items = __webpack_require__(168);
	var Styles = __webpack_require__(170);

	var GoogleBooksSearch = function (_React$Component) {
	  _inherits(GoogleBooksSearch, _React$Component);

	  function GoogleBooksSearch(props) {
	    _classCallCheck(this, GoogleBooksSearch);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(GoogleBooksSearch).call(this, props));
	  ...
	  _createClass(GoogleBooksSearch, [{
	    ...
	    value: function doSearch(query) {
	      ...
	      qwest.get('https://www.googleapis.com/books/v1/volumes', {
	        "q": query,
	    ...
	    value: function render() {
	      ...
	      var subtitleMaxLength = props.subtitleMaxLength;
	      var snippetMaxLength = props.snippetMaxLength;
	      ...
	      return React.createElement(
	        'div',
	        { style: Styles.host },
	        React.createElement(SearchField, { query: query, onUserAction: this.doSearch }),
	        React.createElement(Items, { subtitleMaxLength: subtitleMaxLength, snippetMaxLength: snippetMaxLength, data: data })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchField = function (_React$Component) {
	  ...
	  function SearchField(props) {
	    ...
	    _this.handleUserAction = _this.handleUserAction.bind(_this);
	    return _this;
	  }

	  _createClass(SearchField, [{
	    key: 'handleUserAction',
	    value: function handleUserAction() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Items = function (_React$Component) {
	  ...
	  _createClass(Items, [{
	    key: 'formatAuthorsList',
	    value: function formatAuthorsList(authors) {
	      return authors.join(', ');
	    }
	  }, {
	    key: 'truncateString',
	    value: function truncateString(string, length) {
	      return string.length > length ? string.substr(0, length) + '...' : string;
	    }
	  }, {
	    key: 'truncateSubtitle',
	    value: function truncateSubtitle(subtitle) {
	      return this.truncateString(subtitle, this.props.subtitleMaxLength);
	    }
	  }, {
	    key: 'truncateSnippet',
	    value: function truncateSnippet(snippet) {
	      return this.truncateString(snippet, this.props.snippetMaxLength);
	    }
	  }, {
	    key: 'extractPubDateYear',
	    value: function extractPubDateYear(date) {
	    ...
	    value: function render() {
	      ...
	      var itemNodes = this.props.data.map(function (item, index) {
	        var _Styles$item = Styles.item;
	        var title = _Styles$item.title;
	        var previewLink = _Styles$item.previewLink;
	        var info = _Styles$item.info;
	        var details = _Styles$item.details;
	        var cover = _Styles$item.cover;
	        var snippet = _Styles$item.snippet;
	        var detailsClear = _Styles$item.detailsClear;
	        ...
	        return React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'a',
	                { href: item.volumeInfo.previewLink, target: '_blank', style: previewLink },
	                item.volumeInfo.title,
	                item.volumeInfo.subtitle ? ': ' + _this2.truncateSubtitle(item.volumeInfo.subtitle) : ''
	              )
	            ),
	            React.createElement(
	              'div',
	              { style: info },
	              item.volumeInfo.authors ? _this2.formatAuthorsList(item.volumeInfo.authors) : '',
	              item.volumeInfo.authors && item.volumeInfo.publishedDate ? ' - ' : '',
	              item.volumeInfo.publishedDate ? _this2.extractPubDateYear(item.volumeInfo.publishedDate) : ''
	            ),
	            React.createElement(
	              'div',
	              { style: details },
	              React.createElement(
	                ...
	                React.createElement(
	                  'a',
	                  { href: item.volumeInfo.previewLink, target: '_blank' },
	                  React.createElement('img', { src: item.volumeInfo.imageLinks.smallThumbnail, alt: item.volumeInfo.title, height: '80' })
	                )
	              ),
	              React.createElement('div', { style: snippet, dangerouslySetInnerHTML: { __html: item.searchInfo ? _this2.truncateSnippet(item.searchInfo.textSnippet) : '' } })
	            ),
	            React.createElement('div', { style: detailsClear })
	          )
	        );
	      });
